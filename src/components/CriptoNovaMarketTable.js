...
const CriptoNovaMarketTable = ({ prices, favorites, onToggleFavorite, onLoadMore }) => {
    ...
    <div className="p-6">
      ...
      {onLoadMore && (
        <div className="text-center mt-6">
          <button
            className="px-6 py-2 bg-green-500 text-white rounded-lg font-semibold hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-green-400"
            onClick={onLoadMore}
          >
            Ver Más
          </button>
...
export default CriptoNovaMarketTable;